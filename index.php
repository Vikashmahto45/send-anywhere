<?php
// Main Home Page for send-anywhere.in
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Send Anywhere - Easy & Secure File Transfer</title>
    <meta name="description" content="Send whatever you want, wherever you want. Secure and fast file transfer without any limits.">
    ...
    <style>
        :root {
            --primary-bg: #fff;
            --secondary-bg: #f5f6f8;
            --brand-color: #ef4444; /* Send Anywhere typical red color */
            --brand-hover: #dc2626;
            --text-dark: #1f2937;
            --text-light: #6b7280;
            --border-color: #e5e7eb;
        ...
        * {
        ...
        /* Transfer Widget Widget */
        .widget-wrapper {
            position: relative;
        }

        /* Glowing background blob behind widget */
...
<body>
    ...
    <main class="hero">
        <div class="hero-container">
            ...
            <div class="widget-wrapper">
                <!-- Static UI File Transfer Widget -->
    ...
    <!-- Footer -->
    <footer>
        <p>&copy; <?php echo date("Y"); ?> Send Anywhere. All rights reserved.</p>
        <p>This is a demonstration homepage.</p>
    </footer>
